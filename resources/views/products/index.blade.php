                            ...
                            <tr class="even:bg-[#a78bfa]/10 dark:even:bg-gray-800 transition">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div x-data="{ showModal{{ $product->id }}: false }" class="flex items-center justify-center gap-2">
                                        <!-- Ver detalles -->
                                        <button @click="showModal{{ $product->id }} = true"
                                        ...
                                        <div x-show="showModal{{ $product->id }}"
                                             x-cloak
                                             @click.outside="showModal{{ $product->id }} = false"
                                             x-transition.opacity
                                             class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                                            <div @click.outside="showModal{{ $product->id }} = false"
                                                 class="bg-white dark:bg-gray-900 text-gray-900 dark:text-white w-full max-w-md mx-4 p-6 rounded-lg shadow-xl overflow-y-auto max-h-[90vh] transition-colors">
                                                <div class="flex justify-between items-center mb-4">
                                                    <h2 class="text-xl font-semibold">
                                                        {{ __('Detalles del producto') }}
                                                    </h2>
                                                    <button @click="showModal{{ $product->id }} = false"
